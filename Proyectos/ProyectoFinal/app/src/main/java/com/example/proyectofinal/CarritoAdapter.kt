...
class CarritoAdapter(private val dataSet: ArrayList<Product>) :
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val deleteBtn: Button = view.findViewById(R.id.btn_eliminar)
    }
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.imgView.contentDescription = item.name
